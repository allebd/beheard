                        ...
                        <div class="container">
                                <div class="row">
                                        ...
                                        <main id="main-content" class="col-md-8">                                                                                                                                    
                                                ...
                                                <?php foreach($iheardselect->result() as $adminrows):?>
                                                        ...
                                                        <div class="row">
                                                            <section class="widget">
                                                                ...
                                                                <header class="clearfix">                                                                
                                                                        <a href="<?=base_url();?>profile/articles/" class="control" title='Cancel'><i class="fa fa-times"></i></a>
                                                                </header>
                                                            </section>
                                                                ...
                                                                <!--Content: sign up form-->
                                                                   <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                    <select type="text" name="articletype" disabled>
                                                                                        <option value='<?=$adminrows->articletype?>' selected><?=$adminrows->articletype?></option>
                                                                                        <?php foreach($articletype->result() as $artrow):?>
                                                                                        <option value='<?=$artrow->articletypename;?>'><?=$artrow->articletypename;?></option>
                                                                                        <?php endforeach; ?>
                                                                                    </select>
                                                                            </div>
                                                                    </div><!--Type of News-->
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                    <select type="text" name="typeofnews" disabled>
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                    <input type="text" name="headline" id="headline" placeholder="Headline" value='<?=$adminrows->headline?>' disabled>
                                                                            </div>
                                                                    </div><!--Headline-->
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                    <textarea name="leadstory" id="leadstory" placeholder="Lead Story" disabled><?=$adminrows->leadstory?></textarea>
                                                                            </div>
                                                                    </div><!--Lead Story-->
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                    <textarea name="body" id="body" rows='10' placeholder="Type the story..." disabled><?=$adminrows->body?></textarea>
                                                                            </div>
                                                                    </div><!--body-->
