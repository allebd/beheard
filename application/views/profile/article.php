                                ...
                                <div class="container">
                                        <div class="title-container">
                                                <h3>
                                                    ...
                                                    <span class="primary">Articles</span>
                                                </h3>  
                                        </div>
                                </div>
                        </div>                        
                                        ...
                                        <main id="main-content" class="col-md-8">                                                                                                                                    
                                                ...
                                                <section class="widget">
                                                        ...
                                                        <table class="table table-hover table-striped">                                
                                                                ...
                                                                <tbody>                                                                         
                                                                        <?php $serial = 0; ?>
                                                                        <?php if($iheard->num_rows() > 0):?>
                                                                        <?php foreach($iheard->result() as $articlerows):?>                                                                        
                                                                        <?php $serial = $serial + 1; ?>
                                                                        <tr>
                                                                                <td><?=$serial;?></td>
                                                                                <td style='max-width:100px'><?=ucwords($articlerows->articletype);?></td> 
                                                                                <td style='max-width:200px'><?=ucwords($articlerows->headline);?></td>  
                                                                                <td><a href='<?=base_url();?>profile/viewarticle/<?=$articlerows->article_id;?>'>View</a></td>
                                                                                <td><a href='<?=base_url();?>profile/editarticlepicture/<?=$articlerows->article_id;?>'>Change Picture</a></td>
                                                                                <td><a href='<?=base_url();?>profile/editarticle/<?=$articlerows->article_id;?>'>Edit</a></td>
                                                                        </tr>
                                                                        <?php endforeach; ?>
                                                                        <?php endif; ?> 
                                                                        <?php if($iheard->num_rows() < 1):?>
                                                                        <tr>
                                                                            <td></td>
                                                        ...
                                                        <!--Footer-->
                                                                <div class="footer">
                                                                        ...
                                                                        <div class="read-more">
                                                                                <a href='<?=base_url();?>profile/addarticle' class="btn btn-primary btn-sm">Add Article</a> 
                                                                        </div>
                                                                </div>                                                       
                                                </section>
                                        </main><!--#main-content-->
