                                        ...
                                        <main id="main-content" class="col-md-8">                                                                                                                                    
                                                ...
                                                <article class="article-medium">                                                        
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <form class="form-horizontal" role="form" action='<?=base_url();?>profile/editedarticlepicture/' method='post' enctype='multipart/form-data'>
                                                                    <div class="form-group">
                                                                            <input type="hidden" name='article_id' value='<?=$adminrows->article_id?>' >                                                                            
                                                                    </div><!--Screen Name-->
                                                                    
                                                                    <div class="form-group">
                                                                            <label for="new-screen-name" class="col-sm-2">Old Picture</label>
                                                                            <div class="col-sm-10">
                                                                                    <img src="<?=base_url();?>uploads/<?=$adminrows->picture;?>" alt="Article Picture" />
                                                                            </div>
                                                                    </div><!--Screen Name-->
                                                                    ...
                                                                    <?php endif; ?>
                                                                    <div class="form-group">
                                                                            <label for="new-screen-name" class="col-sm-2">Change Picture <br><sub>(Min-size: 730px by 370px)</sub></label>
                                                                            <div class="col-sm-10">
                                                                    ...
                                                                    <div class="form-group">
                                                                            <label for="new-screen-name" class="col-sm-2">Picture Source</label>
                                                                            <div class="col-sm-10">                                                                                    
                                                                                    <input type='text' name="picturesource" id="picturesource" placeholder="Source" value='<?=$adminrows->picturesource;?>' required />
                                                                            </div>
                                                                    </div><!--Screen Name-->
