                                ...
                                <div class="container">
                                        <div class="title-container">
                                                <h3>
                                                    ...
                                                    <span class="primary">Edit Article</span>
                                                </h3>  
                                        </div>
                                </div>
                        </div>                        
                                        ...
                                        <main id="main-content" class="col-md-8">                                                                                                                                    
                                                ...
                                                <article class="article-medium">                                                        
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <form class="form-horizontal" role="form" action='<?=base_url();?>profile/editedarticle/' method='post' enctype='multipart/form-data'>
