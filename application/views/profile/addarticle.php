                                ...
                                <div class="container">
                                        <div class="title-container">
                                                <h3>
                                                    ...
                                                    <span class="primary">Add Article</span>
                                                </h3>  
                                        </div>
                                </div>
                        </div>                        
                                        ...
                                        <main id="main-content" class="col-md-8">                                                                                                                                    
                                                ...
                                                <article class="article-medium">                                                        
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <form class="form-horizontal" role="form" action='<?=base_url();?>profile/addedarticle/' method='post' enctype='multipart/form-data'>
                                                                    <div class="form-group">
                                                                            <label for="new-password" class="col-sm-2">Article Type</label>
                                                                            <div class="col-sm-10">
                                                                                    <select type="text" name="articletype" required>
                                                                                        <option selected disabled>Article Type</option>
