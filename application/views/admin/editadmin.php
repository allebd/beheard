                                ...
                                <div class="container">
                                        <div class="title-container">
                                                <h3>
                                                    ...
                                                    <span class="primary">Edit Admin</span>
                                                </h3>  
                                        </div>
                                </div>
                        </div>                        
                        ...
                        <div class="container">
                                <div class="row">
                                        ...
                                        <main id="main-content" class="col-md-8">                                                                                                                                    
                                                ...
                                                <?php foreach($adminselect->result() as $adminrows):?>
                                                ...
                                                <article class="article-medium">                                                        
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <form class="form-horizontal" role="form" action='<?=base_url();?>admin/editedadmin' method='post'>
                                                                    <div class="form-group">
                                                                            <input type="hidden" name='admin_id' value='<?=$adminrows->admin_id?>' >

                                                                            <label for="new-screen-name" class="col-sm-2">Screen Name</label>
                                                                            <div class="col-sm-10">
                                                                                    <input type="text" name="screenname" id="new-screen-name" placeholder="Screen Name *" value='<?=$adminrows->screenname?>' required>
                                                                            </div>
                                                                    </div><!--Screen Name-->
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-5">
                                                                                    <input type="text" name="adminfirstname" id="new-first-name" placeholder="First Name *" value='<?=$adminrows->adminfirstname?>' required>
                                                                            </div>  
                                                                            <div class="col-sm-5">
                                                                                    <input type="text" name="adminsurname" id="new-last-name" placeholder="Last Name *"  value='<?=$adminrows->adminsurname?>' required>
                                                                            </div>  
                                                                    </div><!--name-->
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                    <input type="email" name="adminemail" id="new-email" placeholder="Email address *" value='<?=$adminrows->adminemail?>' required>
                                                                            </div>
                                                                    </div><!--email-->
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                    <input type="text" name="adminnumber" id="new-phone" placeholder="Phone number *" value='<?=$adminrows->adminnumber?>' required>
                                                                            </div>
                                                                    </div><!--phone-->
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                    <textarea name="admindescription" id="new-description" placeholder="Brief Decription *" required><?=$adminrows->admindescription?></textarea>
                                                                            </div>
                                                                    </div><!--description-->
