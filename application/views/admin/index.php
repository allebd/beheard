                                        ...
                                        <main id="main-content" class="col-md-8">                                                                                                                                    
                                                ...
                                                <section class="widget">
                                                        ...
                                                        <header class="clearfix">                                                                
                                                                <a href='<?=base_url();?>admin/editprofile' class="control" title='Edit'><i class="fa fa-edit"></i></a>
                                                        </header>
                                                ...
                                                <article class="article-medium">
                                                        <div class="row">
                                                                        ...
                                                                        <div class="frame">
                                                                                <a class="image" href="blog-version-2.html#">
                                                                                        <figure class="image-holder">
                                                                                            <?php if($adminrows->adminphoto == '') :?>
                                                                                                <img src="<?=base_url();?>uploads/imagis.jpg" alt="Profile Photo">
                                                                                            <?php endif;?>
                                                                                            <?php if($adminrows->adminphoto != '') :?>
                                                                                                <img src="<?=base_url();?>uploads/<?=$adminrows->adminphoto;?>" alt="Profile Photo">
                                                                                            <?php endif;?>
                                                                                        </figure>
                                                                                        <div class="image-light"></div>
                                                                ...
                                                                <!--Content-->
                                                                <div class="col-sm-6">
                                                                        <h4><?=ucwords($adminrows->adminsurname);?> <?=ucwords($adminrows->adminfirstname);?> (<?=ucwords($adminrows->screenname);?>)</h4>
                                                                        <p class="post-meta">
                                                                                <span><?=$adminrows->adminemail;?></span><br>
                                                                                <span><?=$adminrows->adminnumber;?></span>
                                                                        </p>
                                                                        <p>
                                                                                <?=$adminrows->admindescription;?>
                                                                        </p>                                    
                                                                </div>
                                                        </div>
                                                        ...
                                                        <!--Footer-->
                                                                <div class="footer">
                                                                        <ul class="tags">
                                                                                <li><a href="<?=base_url();?>admin/editpicture">Change Picture</a></li>
                                                                        </ul> 
                                                                        <div class="read-more">
                                                                                <a href='<?=base_url();?>admin/editprofile' class="btn btn-primary btn-sm">Edit Profile</a> 
                                                                        </div>
                                                                </div>
