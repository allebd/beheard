                                ...
                                <div class="container">
                                        <div class="title-container">
                                                <h3>
                                                    ...
                                                    <span class="primary">Edit Article Type</span>
                                                </h3>  
                                        </div>
                                </div>
                        </div>                        
                        ...
                        <div class="container">
                                <div class="row">
                                        ...
                                        <main id="main-content" class="col-md-8">                                                                                                                                    
                                                ...
                                                <?php foreach($articletypeselect->result() as $adminrows):?>
                                                        ...
                                                        <div class="row">
                                                            <section class="widget">
                                                                ...
                                                                <header class="clearfix">                                                                
                                                                        <a href="<?=base_url();?>admin/articles" class="control" title='Cancel'><i class="fa fa-times"></i></a>
                                                                </header>
                                                            </section>

                                                                <!--Content: sign up form-->
                                                            <form class="form-horizontal" role="form" action='<?=base_url();?>admin/editedarticletype' method='post'>
                                                                    <div class="form-group">
                                                                            <input type="hidden" name='articletype_id' value='<?=$adminrows->articletype_id?>' >

                                                                            <label for="new-screen-name" class="col-sm-3">Article Type Name</label>
                                                                            <div class="col-sm-9">
                                                                                    <input type="text" name="articletypename" id="new-screen-name" placeholder="Screen Name *" value='<?=$adminrows->articletypename?>' required>
                                                                            </div>
                                                                    </div><!--Screen Name-->
