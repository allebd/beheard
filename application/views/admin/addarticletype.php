                                ...
                                <div class="container">
                                        <div class="title-container">
                                                <h3>
                                                    ...
                                                    <span class="primary">Add Article Type</span>
                                                </h3>  
                                        </div>
                                </div>
                        </div>                        
                                        ...
                                        <main id="main-content" class="col-md-8">                                                                                                                                    
                                                ...
                                                <article class="article-medium">                                                        
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <form class="form-horizontal" role="form" action='<?=base_url();?>admin/addedarticletype' method='post'>
                                                                     <div class="form-group">
                                                                            <label for="new-password" class="col-sm-3">Article Type</label>
                                                                            <div class="col-sm-9">
                                                                                    <input type="text" name="articletypename" id="new-username" placeholder="Article Type *" value='<?php echo set_value('articletypename'); ?>' required>
                                                                            </div>
                                                                    </div><!--Username-->
