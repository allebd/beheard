                                ...
                                <div class="container">
                                        <div class="title-container">
                                                <h3>
                                                    ...
                                                    <span class="primary">Article Types</span>
                                                </h3>  
                                        </div>
                                </div>
                        </div>                        
                                        ...
                                        <main id="main-content" class="col-md-8">                                                                                                                                    
                                                ...
                                                <section class="widget">
                                                        ...
                                                        <header class="clearfix">
                                                            <a href='<?=base_url();?>admin/addarticletype' class="control"><i class="fa fa-plus"></i></a>
                                                        </header>
                                                        ...
                                                        <table class="table table-hover table-striped">                                
                                                                ...
                                                                <tbody>                                                                         
                                                                        <?php $serial = 0; ?>
                                                                        <?php if($articletype->num_rows() > 0):?>
                                                                        <?php foreach($articletype->result() as $articlerows):?>                                                                        
                                                                        <?php $serial = $serial + 1; ?>
                                                                        <tr>
                                                                                <td><?=$serial;?></td>
                                                                                <td><?=ucwords($articlerows->articletypename);?></td>
                                                                                <td><a href='<?=base_url();?>admin/article/<?=str_replace(' ','-', $articlerows->articletypename);?>'>View articles</a></td>
                                                                                <td><a href='<?=base_url();?>admin/editarticletype/<?=$articlerows->articletype_id;?>'>Edit</a></td>
                                                                                <td><a href='<?=base_url();?>admin/deletearticletype/<?=$articlerows->articletype_id;?>'>Delete</a></td>
                                                                        </tr>
                                                                        <?php endforeach; ?>
                                                                        <?php endif; ?> 
                                                                        <?php if($articletype->num_rows() < 1):?>
                                                                        <tr>
                                                                            <td></td>
                                                                            <td>No Article Type added.</td>
                                                                            <td></td>
                                                                            <td></td>
                                                                            <td></td>
                                                                        </tr>
                                                        ...
                                                        <!--Footer-->
                                                                <div class="footer">
                                                                        ...
                                                                        <div class="read-more">
                                                                                <a href='<?=base_url();?>admin/addarticletype' class="btn btn-primary btn-sm">Add Article Type</a> 
                                                                        </div>
                                                                </div>                                                       
                                                </section>
                                        </main><!--#main-content-->
