                                ...
                                <div class="container">
                                        <div class="title-container">
                                                <h3>
                                                    ...
                                                    <span class="primary">Edit Google Plus Link</span>
                                                </h3>  
                                        </div>
                                </div>
                        </div>                        
                        ...
                        <div class="container">
                                <div class="row">
                                        ...
                                        <main id="main-content" class="col-md-8">                                                                                                                                    
                                                ...
                                                <?php foreach($gpsocialedit->result() as $adminrows):?>
                                                ...
                                                <article class="article-medium">                                                        
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <form class="form-horizontal" role="form" action='<?=base_url();?>admin/editedgoogleplus' method='post'>
