<?php if(!isset($page_title) || ($page_title != 'signin')): ?>
<!DOCTYPE html>
<?php if(!isset($adminlanding) && !isset($landing) && isset($bloglanding)): ?>
<html id="blog-detail">
<?php endif;?>
<?php if(!isset($adminlanding) && isset($landing) && !isset($bloglanding)): ?>
<html id="blog-version-2">
<?php endif;?>
<?php if(isset($adminlanding) && !isset($landing) && !isset($bloglanding)): ?>
<html id="blog-version-2">
<?php endif;?>
                                                ...
                                                <ul class="nav navbar-nav navbar-right">
                                                        ...
                                                        <li class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                        <li><a href="<?=base_url();?>category/business-and-economy">Business and Economy</a></li>
                                                                </ul>
                                                        <li>
                                                        <li class="dropdown">
